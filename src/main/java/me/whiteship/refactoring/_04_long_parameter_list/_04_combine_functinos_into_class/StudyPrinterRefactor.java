package me.whiteship.refactoring._04_long_parameter_list._04_combine_functinos_into_class;
...
public class StudyPrinterRefactor {

    private int totalNumberOfEvents;

    private List<Participant> participants;

    public StudyPrinterRefactor(int totalNumberOfEvents, List<Participant> participantList) {
     ...
     * | --- | --- | --- | --- | --- |
     */
    private String header() {  // totalNumberOfParticipants : 매개변수
